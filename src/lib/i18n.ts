...
const de = {
  ...
  blog_item_3_label: 'Markt-Hinweis',
  ...
  card_investment_score: 'Markt-Score',
  card_score_strong: 'Hohe Marktstärke',
...
const en: Record<keyof typeof de, string> = {
  ...
  card_investment_score: 'Market Score',
  card_score_strong: 'High market strength',
