...
export const GUIDES: Guide[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        cards: [
          { name: 'Charizard ex (151 Set)', rarity: 'Special Illustration Rare', why: 'Ikonisches Pokémon + höchste Seltenheitsstufe = historisch dauerhaft gefragt', imageUrl: 'https://images.pokemontcg.io/sv3pt5/199.png', setId: 'sv3pt5' },
          { name: 'Pikachu (151 Set)', rarity: 'Illustration Rare', why: 'Das Maskottchen der Serie — global bekannteste Pokémon-Figur', imageUrl: 'https://images.pokemontcg.io/sv3pt5/173.png', setId: 'sv3pt5' },
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        cards: [
          { name: 'Charizard V (Darkness Ablaze)', rarity: 'Rare Holo V', why: 'Ikonisches Pokémon als V-Karte — typisches Beispiel dieser Kategorie', imageUrl: 'https://images.pokemontcg.io/swsh3/19.png', setId: 'swsh3' },
      ...
      },
      {
        ...
        cards: [
          { name: 'Basis-Psycho-Energie (Gold, 151 Set)', rarity: 'Hyper Rare', why: 'Gold-Energiekarten sind der Klassiker unter den Hyper Rares — Setnummer über der Gesamtzahl', imageUrl: 'https://images.pokemontcg.io/sv3pt5/207.png', setId: 'sv3pt5' },
          { name: 'Mew ex (Gold, 151 Set)', rarity: 'Hyper Rare', why: 'Mysteriöses Pokémon in Gold-Ausführung — das Hyper-Rare-Highlight des 151-Sets', imageUrl: 'https://images.pokemontcg.io/sv3pt5/205.png', setId: 'sv3pt5' },
        ],
      },
    ],
    keyPoints: [
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        tip: 'Vorsicht: Stecke Karten nie ohne Sleeve direkt in einen Toploader — die Kanten des Toploaders können Schäden anrichten.',
      },
      {
        ...
        cards: [
          { name: 'Magikarp (Paldea Evolved)', rarity: 'Illustration Rare', why: 'Typischer Binder-Kandidat — beliebtes Artwork für die sortierte Sammlung', imageUrl: 'https://images.pokemontcg.io/sv2/203.png', setId: 'sv2' },
          { name: 'Charizard ex SIR (151)', rarity: 'Special Illustration Rare', why: 'Chase-Cards gehören NICHT in den Binder — Toploader oder Magnethalter', imageUrl: 'https://images.pokemontcg.io/sv3pt5/199.png', setId: 'sv3pt5' },
        ],
      },
      {
        heading: 'Die versteckten Feinde: Licht, Feuchtigkeit & Hitze',
        ...
        tip: 'Praxis-Tipp: Wertvolle Karten in verschlossenen Plastikboxen mit Silicagel-Päckchen lagern — schützt vor Feuchtigkeit und Staub.',
      },
    ],
    keyPoints: [
    ...
    sections: [
      ...
      },
      {
        ...
        cards: [
          ...
          { name: 'Charizard ex SIR (151)', rarity: 'Special Illustration Rare', why: 'Modernes Grading-Ziel — hohe Nachfrage nach PSA-10-Exemplaren', imageUrl: 'https://images.pokemontcg.io/sv3pt5/199.png', setId: 'sv3pt5' },
        ],
