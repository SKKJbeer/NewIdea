    ...
    sections: [
      ...
      },
      {
        ...
        cards: [
          ...
          { name: 'Umbreon VMAX', rarity: 'Alternate Art', why: 'Fansavorit Eevee-Evo + atemberaubendes Artwork = Kultstatus', imageUrl: 'https://images.pokemontcg.io/swsh7/215.png', setId: 'swsh7' },
        ],
      },
      {
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        cards: [
          { name: 'Charizard V (Celebrations)', rarity: 'Ultra Rare', why: 'Hyped Set, ikonisches Design — stabiler Wertzuwachs über die Zeit', imageUrl: 'https://images.pokemontcg.io/cel25/4.png', setId: 'cel25' },
      ...
      },
      {
        ...
        cards: [
          ...
          { name: 'Mewtu ex (151 Set)', rarity: 'Special Illustration Rare', why: 'Legendäres Pokémon, limitierte SIR — einer der konstantesten Preisheber', imageUrl: 'https://images.pokemontcg.io/sv3pt5/204.png', setId: 'sv3pt5' },
        ],
      },
    ],
    keyPoints: [
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        cards: [
          { name: 'Charizard ex (Paldea Evolved)', rarity: 'Ultra Rare', why: 'Typisches Binder-Kandidat — schöne Karte, aber im Binder ok bis ~20 €', imageUrl: 'https://images.pokemontcg.io/sv2/228.png', setId: 'sv2' },
          { name: 'Charizard ex SIR (151)', rarity: 'Special Illustration Rare', why: 'Diese Karte gehört NICHT in den Binder — Toploader oder Magnethalter Pflicht', imageUrl: 'https://images.pokemontcg.io/sv3pt5/201.png', setId: 'sv3pt5' },
        ],
      },
      {
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        cards: [
          { name: 'Charizard (Base Set Shadowless)', rarity: 'Holo Rare', why: 'PSA-10-Exemplare dieser Karte erzielen 5–10× den Ungraded-Wert — der Grading-Klassiker', imageUrl: 'https://images.pokemontcg.io/base1/4.png', setId: 'base1' },
          { name: 'Charizard ex SIR (151)', rarity: 'Special Illustration Rare', why: 'Modernes Grading-Ziel — PSA 10 kostet 2–3× mehr als ungegraded NM', imageUrl: 'https://images.pokemontcg.io/sv3pt5/201.png', setId: 'sv3pt5' },
        ],
