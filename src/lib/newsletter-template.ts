    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px; width:100%;">
        ...
        <tr><td style="background:#ffffff; padding:0 32px 32px; text-align:center;">
          ...
          <a href="${cardmarket}" style="display:inline-block; background:#7c3aed; color:#ffffff; font-size:14px; font-weight:700; padding:12px 28px; border-radius:10px; text-decoration:none; margin:0 6px 12px;">
            🃏 Auf Cardmarket kaufen
          </a>
          <a href="${amazon}" style="display:inline-block; background:#f59e0b; color:#111827; font-size:14px; font-weight:700; padding:12px 28px; border-radius:10px; text-decoration:none; margin:0 6px 12px;">
            📦 Amazon Booster
          </a>
          <p style="margin:16px 0 0; font-size:11px; color:#9ca3af;">* Affiliate-Links — wir erhalten eine kleine Provision, für dich ohne Mehrkosten</p>
        </td></tr>

        <!-- Divider -->
        <tr><td style="background:#ffffff; padding:0 32px;"><hr style="border:none; border-top:1px solid #f3f4f6; margin:0;" /></td></tr>

        <!-- Footer -->
        <tr><td style="background:#ffffff; border-radius:0 0 16px 16px; padding:20px 32px; text-align:center;">
          <p style="margin:0 0 8px; font-size:12px; color:#6b7280;">
            Du erhältst diesen Newsletter weil du dich auf <strong>pokemarketintelligence.de</strong> angemeldet hast.
          </p>
