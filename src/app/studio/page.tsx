          ...
          <section className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            {(output.type === 'market' || output.type === 'newsletter') && (
              <div className="mx-4 mt-0 mb-3 flex items-center gap-3 bg-violet-50 border border-violet-100 rounded-xl px-4 py-3">
                ...
                {published ? (
                  <div className="flex items-center gap-2">
                    <span className="flex items-center gap-1 text-xs font-bold text-green-700 bg-green-100 px-2.5 py-1.5 rounded-lg">
                      <Check size={11} /> Live!
                    </span>
                    <Link
                      href="/marktbericht"
                  ...
                  <button
                    onClick={publish}
                    disabled={publishing}
                    className="flex items-center gap-1.5 bg-violet-600 hover:bg-violet-700 disabled:opacity-60 text-white text-xs font-bold px-3 py-1.5 rounded-lg transition-colors shrink-0"
                  >
