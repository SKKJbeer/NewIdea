    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 pt-10 pb-12 sm:py-20">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center max-w-xs sm:max-w-none mx-auto">
              ...
              <a href="#karten" className="bg-white/10 hover:bg-white/20 text-white font-bold px-6 py-3 rounded-xl transition-colors flex items-center gap-2 justify-center text-sm border border-white/20">
                <TrendingUp size={16} /> Marktpreise ansehen
              </a>
            </div>
            <div className="flex justify-center gap-6 mt-8 text-violet-300 text-xs">
              <div className="flex items-center gap-1.5"><Shield size={12} />Kostenlos & werbefrei</div>
              <div className="flex items-center gap-1.5"><Zap size={12} />KI-gestützt</div>
              <div className="flex items-center gap-1.5"><Mail size={12} />Newsletter inklusive</div>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 pb-16 space-y-10 pt-6">
        ...
        <div id="karten" className="space-y-10">
          {topGainers.length > 0 && <CardGrid cards={topGainers} title="🚀 Top Investment-Karten" />}
        ...
        <section>
          <div className="flex items-center justify-between mb-3">
            ...
            <a href="/artikel" className="text-xs font-semibold text-violet-600 hover:text-violet-800 transition-colors">Alle ansehen →</a>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {[
              ...
              <a key={item.label} href={item.href} className="bg-white rounded-2xl border border-gray-100 p-4 hover:border-violet-200 hover:shadow-sm transition-all flex items-center gap-3 group">
