...
export const metadata: Metadata = {
  ...
  description: 'Suche gezielt nach Pokémon-Karten und sieh sofort Marktwert, Trend und 30-Tage-Preisverlauf. Finde heraus, wie viel deine Karten wert sind.',
};
      ...
      <header className="bg-gradient-to-br from-violet-700 via-indigo-700 to-indigo-900 text-white">
        <div className="max-w-3xl mx-auto px-4 pt-10 pb-12 sm:py-14 text-center">
          ...
          <h1 className="text-2xl sm:text-4xl font-black mb-3">
            Was ist deine Karte<br className="sm:hidden" /> <span className="text-yellow-300">wert?</span>
          </h1>
