...
export async function GET(request: Request) {
  ...
  const data = {
    ...
    features: {
      ...
      portfolioKonto: { working: env('NEXT_PUBLIC_SUPABASE_URL') && env('NEXT_PUBLIC_SUPABASE_ANON_KEY'), label: 'Portfolio-Konto (Google/Apple)', effect: 'Ohne: Portfolio liegt nur im Browser des Besuchers' },
